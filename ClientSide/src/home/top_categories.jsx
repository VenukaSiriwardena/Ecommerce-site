    ...
    <>
      <div className="container mx-auto px-4 mt-20">
        <div className="text-2xl md:text-3xl font-bold text-center underline-custom">
          Check Out Our <span className="text-blue-custom">Latest Arrivals</span>
        </div>
      </div>
      ...
      <button className="flex items-center justify-center font-bold text-center bg-transparent border-none" onClick={() => window.location.href = '/latest'}>
          <span>View All</span>
